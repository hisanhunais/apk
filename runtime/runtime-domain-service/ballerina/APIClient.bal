...
public class APIClient {
    ...
    isolated function validateOperationPolicyData(APIOperationPolicies? operationPolicies, commons:Organization organization) returns BadRequestError|() {
        if operationPolicies is APIOperationPolicies {
            ...
            BadRequestError|() badRequestError = self.validatePolicyNameAndParameters(operationPolicies.request, organization);
            if (badRequestError == ()) {
                // Validating response operation policy data.
                return self.validatePolicyNameAndParameters(operationPolicies.response, organization);
            } else {
                return badRequestError;
            }
        }
    ...
    isolated function validatePolicyNameAndParameters(OperationPolicy[]? policyData, commons:Organization organization) returns BadRequestError|() {
